...
class CtInstaller(QObject):
    ...
    BUFFER_SIZE = 4096
    CT_URL = 'https://api.github.com/repos/daailouivan/steamtinkerlaunch/releases'
    CT_BRANCHES_URL = 'https://api.github.com/repos/daailouivan/steamtinkerlaunch/branches'
    CT_GH_URL = 'https://github.com/daailouivan/steamtinkerlaunch'
    ...
    def __fetch_github_data(self, tag):
        ...
        """
        if self.allow_git:
            return {'version': tag, 'download': f'https://github.com/daailouivan/steamtinkerlaunch/archive/{tag}.tar.gz'}
